...
public class P874 {
    public static int robotSim(int[] commands, int[][] obstacles) {
        int[] directions = {1, 1, -1, -1};//north east south west
        int direc = 0;
        ...
        for(int i : commands) {
        	...
        	if(i == -1) {
        		...
        		b[0] = a[0]; b[1] = a[1];
        		if(direc % 2 == 0) {
        			b[1] = b[1] + i * directions[direc];
        		} else {
        			b[0] = b[0] + i * directions[direc];
        		}
        		 System.out.println("("+b[0] + "," + b[1]+")");
        		
        		int[] c = isObstacled(a, b, obstacles);
        		if(c.length == 0) {
        			a[0] = b[0];a[1] = b[1];
        			//System.out.println("...");
        		} else {
            		if(direc % 2 == 0) {
            			a[1] = c[1] + directions[direc] * -1;
            			a[0] = c[0];
            		} else {
            			a[0] = c[0] + directions[direc] * -1;
            			a[1] = c[1];
            		}
        		}
    ...
    public static int[] isObstacled(int[] a, int[]b, int[][] obstacles) {
    	...
    	for(int[] c : obstacles) {
    		if(b[0] == c[0] && b[1] == c[1]) {
    			...
    			if((a[1] - c[1]) * (b[0] - c[0]) == (b[1] - c[1]) * (a[0] * c[0])) {
    				if(a[0] == b[0]) {
    					...
    					if((c[0] > a[0] && c[1] > a[1] && c[0] < b[0] && c[1] < b[1]) || (c[0] < a[0] && c[1] < a[1] && c[0] > b[0] && c[1] > b[1])) {
    						System.out.println("("+a[0] + "," + a[1]+")->("+b[0]+","+b[1]+")+("+c[0]+","+c[1]+")");
    						return c;
    					}
